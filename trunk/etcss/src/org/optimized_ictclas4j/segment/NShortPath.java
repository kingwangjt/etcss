...
import org.optimized_ictclas4j.bean.Queue;
import org.optimized_ictclas4j.bean.QueueNode;
...
public class NShortPath {
    ...
    public ArrayList<ArrayList<Integer>> getPaths() {
        ...
        ArrayList<Integer> onePath;// 一条分词路径

        Queue queResult;
        int curNode, curIndex;
        int pathIndex = 0;
